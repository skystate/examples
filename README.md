...
| --- | --- | --- |
| [notes](./notes) | A minimal React and TypeScript notepad with auth and persistence handled by SkyState. | [skystate.github.io/examples/notes](https://skystate.github.io/examples/notes/) |
